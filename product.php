...
echo "<div class='col-md-5'>";
    ...
    echo "<div class='m-b-10px'>";
		// make html
        $product_genre = htmlspecialchars_decode(htmlspecialchars_decode($product->genre));
		
		// show to user
        echo $product_genre;
    echo "</div>";
	
    echo "<div class='product-detail'>Platform:</div>";
    echo "<div class='m-b-10px'>";
		// make html
        $product_platform = htmlspecialchars_decode(htmlspecialchars_decode($product->platform));
